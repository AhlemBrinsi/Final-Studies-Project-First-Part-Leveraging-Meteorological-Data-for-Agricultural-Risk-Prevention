...
model = load_transformer_model('saved_models/WeatherTransformer_20250701_140950')
...
transformer_model = load_model('saved_models/WeatherTransformer_20250701_140950/transformer_model.keras')

# Load label encoder
with open('saved_models/WeatherTransformer_20250701_140950/label_encoder.pkl', 'rb') as f:
